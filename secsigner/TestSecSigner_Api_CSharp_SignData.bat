@echo off
REM $Id: TestSecSigner_Api_CSharp_SignData.bat,v 1.4 2015/05/22 15:59:23 tk Exp $
REM $Source: /encfs/checkout/antonio/cvs/SecCommerceDev/seccommerce/secsignersigg/dll/TestCallSecSignerDLLCSharp/developer/TestSecSigner_Api_CSharp_SignData.bat,v $
REM
...
REM 4: Maximum memory in MB for the Java VM
...
java -fullversion
TestCallSecSignerDLLCSharp.exe 2 secsigner.properties D:\SecSigner\ 1024 D:\SecSigner\test\
pause
