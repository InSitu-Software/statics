@echo off
REM $Id: TestSecSigner_Api_EncryptDataOnly.bat,v 1.3 2015/05/22 15:59:23 tk Exp $
REM $Source: /encfs/checkout/antonio/cvs/SecCommerceDev/seccommerce/secsignersigg/dll/TestCallSecSignerDLL/developer/TestSecSigner_Api_EncryptDataOnly.bat,v $
REM
REM This batch invokes the encryption of some test files
...
java -fullversion
TestCallSecSignerDLL.exe 5 D:\SecSigner\CallSecSignerDLL.dll secsigner.properties D:\SecSigner\ 1024 D:\SecSigner\test\
pause
