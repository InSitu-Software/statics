@echo off
REM $Id: TestSecSigner_Api_SignData.bat,v 1.4 2015/05/22 15:59:23 tk Exp $
REM $Source: /encfs/checkout/antonio/cvs/SecCommerceDev/seccommerce/secsignersigg/dll/TestCallSecSignerDLL/developer/TestSecSigner_Api_SignData.bat,v $
REM
...
java -fullversion
TestCallSecSignerDLL.exe 2 D:\SecSigner\CallSecSignerDLL.dll secsigner.properties D:\SecSigner\ 1024 D:\SecSigner\test\
pause
